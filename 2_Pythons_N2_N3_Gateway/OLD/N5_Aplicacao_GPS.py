...
while True:
    ...
    for i in range(1,len(linhas)):
        ...
        # ou seja: partes[byte_do_pacote + 22]

        # Luminosidade -> UL_B18 / UL_B19 (ADC de 12 bits)
        UL_B18 = int(partes[56]) #40 2 + 20 + 18 # 2 + 36 + 18
        UL_B19 = int(partes[57]) #41 2 + 20 + 19 # 2 + 36 + 19
